...
<!--This file decides what appears in the header based on user role-->
    <div class="nav-links">
        ...
        <?php elseif ($user_role === 'student'): ?>
            ...
            <a href="../student/student_formhistory.php">Sejarah Borang</a>
            <a href="../student/student_profile.php">Profil Murid</a>
            <a href="../student/student_cocurricular.php">Profil & Aktiviti Kokurikulum</a>
            <a href="../cocurricular/cocurricular_board.php">Papan Kokurikulum</a>
        <?php else: ?>
